...
public class EmployTest {
	@Test
	    ...
	    Employ emp = new Employ(1, "Satya", Gender.MALE, "Java", "Manager", 99765);
	    String result = "Employ [empno=1, name=Satya, gender=MALE, ept=Java, desig=Manager, basic=99765.0]";
	...
	public void testConstructor() {
		...
		assertEquals(99765, emp.getBasic(),0);
	}
