...
public class Calc {
	...
	public void addition(ActionEvent evt) {
        ...
        CalcTestRemote statelessRemoteCalculator = null;
		try {
	...
	private static CalcTestRemote lookupRemoteStatelessCalculator() throws NamingException {
	    ...
	    //    final String appName = "";
	      ...
	      //  final String moduleName = "EJBModule";
	        ...
	        final String beanName = "CalcTest";
	        System.out.println(beanName);
	        // the remote view fully qualified class name
	   //     System.out.println(RemoteCalculator.class.getName());
	        final String viewClassName = CalcTestRemote.class.getName();
	        // let's do the lookup
