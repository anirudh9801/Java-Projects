...
<html>
	...
	<h:inputText value="#{customerFound.cusid}" /><br/> 
	<br/><br/>
	Select Vendor : 
...
<p>
	Selected Vendor Value is : <h:outputText value="#{vendorDao.localCode}"></h:outputText>
</p>
<p>
Selected Vendor Id is : <h:outputText value="#{vendorDao.venId}"></h:outputText>
</p>
<br/><br/>
	Select Restaurant : 
		<h:selectOneMenu id="restaurantSelected" value="#{customerDao.localCode}" onchange="submit()"
	valueChangeListener="#{customerDao.employLocaleCodeChanged}">
    <f:selectItems value="#{customerDao.showCustomerWalleNames()}"/>
    </h:selectOneMenu>
	</h:form>
